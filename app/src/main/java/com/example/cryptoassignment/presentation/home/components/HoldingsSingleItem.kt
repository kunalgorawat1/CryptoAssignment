    ...
    Card(
        ...
        Row {
            ...
            Column(
                ...
                Text(text = yourCryptoHolding.current_bal_in_token + " " + yourCryptoHolding.title,
                    modifier = paddingModifierText,
        ...
        Column(
            ...
            Text(text = "$" + yourCryptoHolding.current_bal_in_usd,
                modifier = Modifier.padding(start = 5.dp, top = 5.dp, bottom = 5.dp, end = 10.dp),
                fontWeight = FontWeight.Bold,
                fontSize = 15.sp
            )
            Row() {
                Text(text = "$${yourCryptoHolding.current_bal_in_token} (+21.51%)",
                    modifier = Modifier.padding(start = 5.dp, top = 5.dp, bottom = 5.dp, end = 10.dp),
                    fontWeight = FontWeight.Bold,
